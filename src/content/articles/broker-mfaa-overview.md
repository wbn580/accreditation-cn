---
title: "MFAA 澳洲贷款与金融协会：全面解析与最新认证标准"
description: "本文全面解析MFAA（澳洲贷款与金融协会）的起源、认证范围、全球统计、费用时效及最新认证标准，为金融从业者提供权威参考。"
category: "broker"
...
- **贷款经纪人（Mortgage Broker）**：需完成 MFAA 认可的 Diploma of Finance and Mortgage Broking 课程，并通过协会的职业道德测试。截至 2026 年 4 月，该类别占认证总数的 78%。
- **金融顾问（Financial Adviser）**：要求持有澳洲金融服务执照（AFSL）或作为授权代表，并满足 MFAA 的持续教育（CPD）要求。
- **信贷经理（Credit Manager）**：面向银行、非银行金融机构的信贷审批人员，认证标准基于 ASIC 2025 年发布的《信贷责任指南》。
...
- **申请费**：首次认证申请费为 550 澳元（含 GST），适用于贷款经纪人及金融顾问类别。
- **年费**：认证会员年费为 350 澳元（2026 年标准），含持续教育（CPD）资源接入费用。
- **时效**：认证有效期为 12 个月，到期需续期并完成至少 30 小时的 CPD 培训。据 MFAA 2025 年度审计报告，认证续期率为 91%，平均处理周期为 10 个工作日。
...
- **道德测试升级**：引入基于 ASIC 2024 年《金融服务业道德准则》的在线情景模拟测试，通过率要求从 70% 提高至 80%。
- **持续教育要求**：CPD 小时数从 25 小时增至 30 小时，其中至少 5 小时需涵盖消费者保护法更新内容。
- **机构认证**：要求经纪机构提供至少 2 名认证经纪人的雇佣证明，并提交年度合规审计报告。
...
- MFAA. (2026). *Annual Report 2026*. https://www.mfaa.com.au/annual-report
- Australian Securities and Investments Commission (ASIC). (2025). *Regulatory Report 2025*. https://asic.gov.au/regulatory-resources/financial-services
- Australian Bureau of Statistics (ABS). (2025). *Finance Industry Statistical Bulletin 2025*. https://www.abs.gov.au/statistics/industry/finance
- MFAA. (2025). *Accreditation Standard 4.0*. https://www.mfaa.com.au/accreditation-standard
- New Zealand Financial Advisers Association (IFA). (2025). *Mutual Recognition Agreement with MFAA*. https://www.ifa.org.nz/mutual-recognition
